          ...
          <div className="containerInfo">
            ...
            <div className="locationsContainer">
              <div className="location">
                ...
                <input placeholder="מיקום" className="locationInput" type="text" />
              </div>
            </div>
        ...
        <div className="containerInfo">
          ...
          <div className="identification">
            <div className="numberContainer">
              ...
              <input placeholder="123" className="numberComputerInput" type="text" />
            </div>
          ...
          <div className="catalogNumber">
              ...
              <div className="signed">
                ...
                <input placeholder="שם מלא" className="signedInput" type="text" />
              </div>
          </div>
          <div className="commentsContainer">
            <div className="comments">
        ...
        <div className="containerInfo">
          ...
          <div className="identification">
            <div className="numberContainer">
              ...
              <input placeholder="טנק" className="numberComputerInput" type="text" />
            </div>
            <div className="chNumber">
              <p className="textInput">מספר צ</p>
              <input placeholder="צ" className="chNumberInput" type="text" />
          ...
          <div className="catalogNumber">
              ...
              <div className="signed">
                ...
                <input placeholder="מאור " className="signedInput" type="text" />
              </div>
          </div>
          <div className="commentsContainer">
            <div className="comments">
        ...
        <div className="containerInfo">
          ...
          <div className="identification">
            <div className="numberContainer">
              ...
              <input placeholder="16" className="numberComputerInput" type="text" />
            </div>
            <div className="chNumber">
              <p className="textInput">מי חתום על ההתקן</p>
              <input placeholder="אלקנה" className="chNumberInput" type="text" />
            </div>
          </div>
          ...
          <div className="catalogNumber">
              ...
              <div className="signed">
                ...
                <input placeholder="כן/לא " className="signedInput" type="text" />
              </div>
          </div>
          <div className="commentsContainer">
            <div className="comments">
